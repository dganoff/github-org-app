      ...
      livereload: {
        options: {
          middleware: function (connect) {
            return [
              connect.static(".tmp"),
              connect().use("/bower_components", connect.static("./bower_components")), // used for sourcemaps
              connect().use("/src", connect.static("./src")), // used for sourcemaps
